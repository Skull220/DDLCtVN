...
label ch2_m_end:
    ...
    m "But life isn't like a video game. You can't just save your progress!"
    m "You'll need to be absolutely sure you want to do something before you make a choice..."
...
label ch3_m_end:
    ...
    m "Humans aren't one-dimensional creatures."
    m 1a "Anyway..."
    m 3b "Here's Monika's Writing Tip of the Day!"
