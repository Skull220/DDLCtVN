label natsukiroute:
    ...
    show natsuki m1s at t11 zorder 2
    ...
    show natsuki m12b at t11 zorder 2
    n m12b "[player]."
    mc "Hmm? What’s up?"
    ...
    show natsuki s2ba at t11 zorder 2
    n "Hey."
    ...
    menu:
        ...
        "Let Natsuki in.":
            ...
            n s1bh "Here. Now, I’m going to get you something warm, so you can feel better."
            n "Stay here."
            show natsuki at thide zorder 1
            hide natsuki
            ...
            n s3bw "Hmph, whatever."
            n "You’re my boyfriend now, so I need to take care of you!"
            n s3bq "You’d do the same, right?"
            mc "I suppose, yes, I would."
            n s3bx "What do you mean, you ‘suppose?’"
            ...
            show natsuki s3bu at t11 zorder 2
            "After a few seconds, she grabs my hand, and I look at her in suspicion."
            n s2bw "I’m just trying to...keep your pulse in check."
            ...
            n s1by "So, why was this next to a bottle of lotion, [player]?"
            ...
            n s4ba "Well, I’ve gotta go then."
            n "Bye, [player]."
            mc "Bye, Natsuki."
            mc "I hope I didn’t make you sick..."
            n s4bf "Stop worrying about me!"
        ...
        "Tell her to come back next week.":
            ...
            n s1bu "Yeah, sorry."
            n "Well, I'll go then."
            n s1bo "But you better take care of yourself!"
    ...
    if NatsukiVar >= 3:
        ...
        show natsuki 6ba at t11 zorder 2
        ...
        n 6bb "You don’t have to move so much, idiot."
