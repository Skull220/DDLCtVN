label natsukiroute:
    ...
    menu:
        ...
        "An Action game.":
            ...
            n 22bb "[player]. I hate this."
            "She gets off my lap."
            mc "Did I do something wrong?"
            n 12be "No, dummy, it’s just..."
            mc "What’s up?"
            n 22bc "Nothing, it’s fine!"
            n "Just continue!"
            mc "Nope. What is wrong?"
            "She hesitates."
            "Then, she speaks up."
            n 12bd "I...I hate how good this feels."
            n "I don’t deserve to feel like this, especially with you."
            n 22be "I’ve been nothing but mean to you since we’ve met."
            n "I’m sorry."
            mc "Don’t be, Natsuki."
